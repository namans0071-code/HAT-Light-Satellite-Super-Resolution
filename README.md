...
*Figure 2: Visual comparison between Bicubic interpolation, Ground Truth, and HAT-Light output across True Color (RGB) and Color Infrared (CIR / False Color). Low-Resolution (LR) input is generated by first applying an optical Point Spread Function (PSF) Gaussian blur kernel ($\sigma \in [0.6, 1.4]$) followed by 4× antialiased bicubic downsampling to simulate real satellite sensor physics.*
